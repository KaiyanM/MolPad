...
unique(test_graphptw$taxonomic.scope)

c("hormonal proteins","structural proteins","enzymes","storage proteins","antibodies","transport proteins")
...
as.data.frame(t(test_data[1:5,1:10]))
