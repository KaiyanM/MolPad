...
#' @param iter.max A number of the maximum iterations allowed in k-means. See also `stats::kmeans`.
...
#' attempts. For larger data, 'nstart' can be set lower or just set to 1. See also `stats::kmeans`.
